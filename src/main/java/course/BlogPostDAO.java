...
public class BlogPostDAO {
    ...
    public List<Document> findByDateDescending(int limit) {
        ...
        FindIterable<Document> postList = postsCollection.find().limit(limit).sort(new Document("date", -1));
        MongoCursor<Document> iterator = postList.iterator();
    ...
    public void addPostComment(final String name, final String email, final String body,
        ...
        List<String> comments = post.get("comments", ArrayList.class);
